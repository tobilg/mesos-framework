 ...
 * @param {array} offers - The array of {@link https://github.com/apache/mesos/blob/1.3.x/include/mesos/v1/mesos.proto#L49|OfferID}s which should be accepted.
 * @param {array} taskInfos - The array of {@link https://github.com/apache/mesos/blob/1.3.x/include/mesos/v1/mesos.proto#L1452|Operation} objects.
 * @param {object} filters - The {@link https://github.com/apache/mesos/blob/1.3.x/include/mesos/v1/mesos.proto#L1911|Filters} object.
 */
Scheduler.prototype.accept = function (offers, operations, filters) {
    ...
    // Set the Call object
    var Call = helpers.fixEnums(new mesos.scheduler.Call(new mesos.FrameworkID(self.frameworkId), "ACCEPT", null, Accept));
 ...
 * @param {array} offers - The array of {@link https://github.com/apache/mesos/blob/1.3.x/include/mesos/v1/mesos.proto#L49|OfferID}s which should be declined.
 * @param {object} filters - The {@link https://github.com/apache/mesos/blob/1.3.x/include/mesos/v1/mesos.proto#L1911|Filters} object.
 */
Scheduler.prototype.decline = function (offers, filters) {
    ...
    // Set the Call object
    var Call = helpers.fixEnums(new mesos.scheduler.Call(new mesos.FrameworkID(self.frameworkId), "DECLINE", null, null, Decline));
 ...
 * @param {Object} taskId The {@link https://github.com/apache/mesos/blob/1.3.x/include/mesos/v1/mesos.proto#L71|TaskID} to kill.
 * @param {Object} agentId The {@link https://github.com/apache/mesos/blob/1.3.x/include/mesos/v1/mesos.proto#L59|AgentID} the task is running on.
 */
 ...
 * @param {string} agentId The {@link https://github.com/apache/mesos/blob/1.3.x/include/mesos/v1/mesos.proto#L59|AgentID} the task is running on.
 * @param {string} executorId The {@link https://github.com/apache/mesos/blob/1.3.x/include/mesos/v1/mesos.proto#L81|ExecutorID} whcih runs the task.
 */
 ...
 * @param {string} taskId The {@link https://github.com/apache/mesos/blob/1.3.x/include/mesos/v1/mesos.proto#L71|TaskID} to kill.
 * @param {string} agentId The {@link https://github.com/apache/mesos/blob/1.3.x/include/mesos/v1/mesos.proto#L59|AgentID} the task is running on.
 */
 ...
 * @param {string} agentId The {@link https://github.com/apache/mesos/blob/1.3.x/include/mesos/v1/mesos.proto#L59|AgentID} the task is running on.
 * @param {string} executorId The {@link https://github.com/apache/mesos/blob/1.3.x/include/mesos/v1/mesos.proto#L81|ExecutorID} which runs the task.
 ...
 * @param {array} requests The {@link https://github.com/apache/mesos/blob/1.3.x/include/mesos/v1/mesos.proto#L1410|Request} objects which should be sent to the server.
 */
 ...
 * @param {array} roles The {@link https://github.com/apache/mesos/blob/1.3.x/include/mesos/v1/mesos.proto#L2696|Role} objects which should be sent to the server.
 */
 ...
 * @param {array} inverseOffersIds The {@Link https://github.com/apache/mesos/blob/1.3.x/include/mesos/v1/mesos.proto#L49|OfferID} array which should be sent to the server.
 * @param {object} filters The {@link https://github.com/apache/mesos/blob/1.3.x/include/mesos/v1/mesos.proto#L1911|Filters} object which should be sent to the server.
 */
Scheduler.prototype.acceptInverseOffers = function (inverseOffersIds, filters) {
    ...
    var payload = {
        ...
        "inverse_offer_ids": inverseOffersIds,
        "filters": filters
    };
